...
private int modifiedBy = -1;  // negative means not modified
   ...
   /**
    * Sets the buffer's reference bit.
    */
   void setReferenceCounter(int refValue) {
      reference_counter = refValue;
   }
   
   /**
    * Decrements the buffer's reference bit.
    */
   ...
   /**
    * Returns the value of the buffer's reference counter 
    */
   ...
   public Block saveBlock(String filename)
   {
	   int BlockNo = SimpleDB.fileMgr().size(filename);
	   Block b = new Block(filename, BlockNo);
	   //System.out.println("BLOCK NUM : ............................."+BlockNo);
	   contents.write(b);
	   System.out.println(contents.getString(1));
	   return b;
   }
   
   public void restoreBlock(String filename, int blockNum)
   {
	   Block b = new Block(filename, blockNum);
	   contents.read(b);
	   contents.write(blk);
   }
}